                    ...
                    <div class="container d-flex flex-stack flex-wrap gap-4" id="kt_header_container">
                        ...
                        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-10 pb-lg-0"
                            ...
                            <h1 class="d-flex flex-column text-gray-900 fw-bold my-0 fs-1">
                                @auth
                                    Olá, {{ auth()->user()->name }}
                                    <small class="text-muted fs-6 fw-semibold pt-1">{{ auth()->user()->getPerfilFormatado() }}</small>
                                @else
                                    Sistema Parlamentar
                                    <small class="text-muted fs-6 fw-semibold pt-1">Faça login para acessar</small>
                                @endauth
                            </h1>
                            <!--end::Heading-->
                        </div>
                            ...
                            <div class="d-flex align-items-center ms-3 ms-lg-4">
                                ...
                                <div class="btn btn-icon btn-color-gray-700 btn-active-color-primary btn-outline w-40px h-40px position-relative"
                                    ...
                                    <div class="symbol symbol-40px">
                                        <div class="symbol-label fs-6 fw-bold text-white bg-{{ auth()->user()->getCorPerfil() }}">
                                            {{ auth()->user()->avatar }}
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="menu-content d-flex align-items-center px-3">
                                            ...
                                            <div class="d-flex flex-column flex-grow-1 pe-0 min-w-0">
                                                <div class="fw-bold d-flex flex-wrap align-items-center fs-6 fs-md-5 gap-1">
                                                    ...
                                                    <span class="badge badge-light-{{ auth()->user()->getCorPerfil() }} fw-bold fs-8 px-2 py-1">
                                                        {{ auth()->user()->getPerfilFormatado() }}
                                                    </span>
                                                </div>
                                                <a href="#" class="fw-semibold text-muted text-hover-primary fs-8 fs-md-7 text-truncate">
                                                    {{ auth()->user()->email }}
                                                </a>
                                            </div>
                                            <!--end::Username-->
