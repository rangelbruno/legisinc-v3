                ...
                <div class="aside-menu flex-column-fluid ps-3 ps-lg-5 pe-3 mb-9" id="kt_aside_menu">
                    ...
                    <div class="w-100 hover-scroll-overlay-y d-flex pe-3" id="kt_aside_menu_wrapper"
                        ...
                        <div class="menu menu-column menu-rounded menu-sub-indention menu-active-bg fw-semibold my-auto"
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ request()->routeIs('admin.*') || request()->routeIs('usuarios.*') || request()->routeIs('tests.*') ? 'here show' : '' }}">
                                <span class="menu-link">
                                    <span class="menu-icon">
                                ...
                                <div class="menu-sub menu-sub-accordion {{ request()->routeIs('admin.*') || request()->routeIs('usuarios.*') || request()->routeIs('tests.*') ? 'show' : '' }}">
