<div id="kt_aside" class="aside py-9" data-kt-drawer="true" data-kt-drawer-name="aside"
    ...
    <div class="aside-logo flex-column-auto px-9 mb-9" id="kt_aside_logo">
        ...
        <a href="{{ route('dashboard') }}">
            <img alt="Logo" src="{{ asset('assets/media/logos/legisinc.svg') }}" class="h-100px logo theme-light-show" />
            <img alt="Logo" src="{{ asset('assets/media/logos/legisinc-bg.svg') }}" class="h-100px logo theme-dark-show" />
        </a>
        <!--end::Logo-->
    </div>
    <!--end::Brand-->
