...
@section('title', 'Testes de API - Sistema Parlamentar')
                        ...
                        <div class="card-body d-flex flex-column justify-content-center align-items-center py-20">
                            <div class="symbol symbol-100px mb-10">
                                <span class="symbol-label bg-light-warning text-warning">
                                    <i class="ki-duotone ki-technology-2 fs-1">
                                        <span class="path1"></span>
                                        <span class="path2"></span>
                                    </i>
                                </span>
                            </div>
                            <h1 class="fw-bold text-dark fs-3 mb-5">Testes de API</h1>
                                ...
                                <div class="row g-5 mb-8">
                                    <div class="col-md-4">
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <span class="fw-semibold">Endpoints REST</span>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="d-flex align-items-center mb-3">
                                            <i class="ki-duotone ki-check-circle text-success fs-3 me-3"></i>
                                            <span class="fw-semibold">Autenticação JWT</span>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="d-flex align-items-center mb-3">
                                            <i class="ki-duotone ki-check-circle text-success fs-3 me-3"></i>
                                            <span class="fw-semibold">Validação de Responses</span>
                                        </div>
                                    </div>
                                </div>
