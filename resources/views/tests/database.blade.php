...
@section('title', 'Testes de Database - Sistema Parlamentar')
                ...
                <div class="col-xl-12">
                    <div class="card card-xl-stretch">
                        <div class="card-body d-flex flex-column justify-content-center align-items-center py-20">
                            ...
                            <h1 class="fw-bold text-dark fs-3 mb-5">Testes de Database</h1>
                                ...
                                <div class="row g-5 mb-8">
                                    <div class="col-md-4">
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <span class="fw-semibold">Integridade de Dados</span>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="d-flex align-items-center mb-3">
                                            <i class="ki-duotone ki-check-circle text-success fs-3 me-3"></i>
                                            <span class="fw-semibold">Migrations</span>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="d-flex align-items-center mb-3">
                                            <i class="ki-duotone ki-check-circle text-success fs-3 me-3"></i>
                                            <span class="fw-semibold">Performance de Queries</span>
                                        </div>
                                    </div>
                                </div>
