...
@section('title', 'Fluxo de Documentos - Documentação')
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex align-items-center">
                        <div>
                            <h5 class="mb-0">Fluxo Completo do Documento - Sistema Legisinc</h5>
                            <p class="text-sm mb-0">Documentação detalhada do fluxo do documento desde a criação até o protocolo final</p>
                        </div>
                        <div class="ms-auto">
