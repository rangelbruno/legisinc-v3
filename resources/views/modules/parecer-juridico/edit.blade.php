...
@section('title', 'Editar Parecer Jurídico')
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ route('parecer-juridico.show', $parecerJuridico) }}" class="text-muted text-hover-primary">Parecer #{{ $parecerJuridico->id }}</a>
                    </li>
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-400 w-5px h-2px"></span>
                    </li>
            ...
            <div class="row gy-5 g-xl-10">
                ...
                <div class="col-xl-12">
                    ...
                    <div class="alert alert-primary d-flex align-items-center p-5 mb-5">
                        <i class="ki-duotone ki-information-4 fs-2hx text-primary me-4">
                            <span class="path1"></span>
                            <span class="path2"></span>
                            <span class="path3"></span>
                        </i>
                        <div class="d-flex flex-column">
                            <h4 class="mb-1 text-dark">Edição de Parecer Jurídico</h4>
                            <span>Você está editando o parecer jurídico nº {{ $parecerJuridico->id }} emitido em {{ $parecerJuridico->data_emissao->format('d/m/Y') }}.</span>
                        </div>
                    </div>
                    <!--end::Alert-->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <span class="fs-6">{{ $parecerJuridico->proposicao->tipo }}</span>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label fw-bold">Número:</label>
                                        <span class="fs-6">{{ $parecerJuridico->proposicao->numero ?? 'Não informado' }}</span>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label fw-bold">Protocolo:</label>
                                        <span class="fs-6">{{ $parecerJuridico->proposicao->numero_protocolo ?? 'Não protocolado' }}</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label fw-bold">Autor:</label>
                                        <span class="fs-6">{{ $parecerJuridico->proposicao->autor->name ?? 'Não informado' }}</span>
                                    </div>
                                    <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <p class="fs-6 text-gray-800">{{ $parecerJuridico->proposicao->ementa }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card card-flush">
                        <div class="card-header">
                            <div class="card-title">
                                <h3 class="fw-bold">Editar Parecer Jurídico</h3>
                            </div>
                        </div>
                        
                        <form method="POST" action="{{ route('parecer-juridico.update', $parecerJuridico) }}">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check form-check-custom form-check-solid">
                                                <input class="form-check-input" type="radio" name="tipo_parecer" 
                                                       ...
                                                       {{ old('tipo_parecer', $parecerJuridico->tipo_parecer) == 'FAVORAVEL' ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check form-check-custom form-check-solid">
                                                <input class="form-check-input" type="radio" name="tipo_parecer" 
                                                       ...
                                                       {{ old('tipo_parecer', $parecerJuridico->tipo_parecer) == 'CONTRARIO' ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check form-check-custom form-check-solid">
                                                <input class="form-check-input" type="radio" name="tipo_parecer" 
                                                       ...
                                                       {{ old('tipo_parecer', $parecerJuridico->tipo_parecer) == 'COM_EMENDAS' ? 'checked' : '' }}>
                                ...
                                <div class="mb-10">
                                    ...
                                    <textarea name="fundamentacao" class="form-control form-control-solid @error('fundamentacao') is-invalid @enderror" 
                                              rows="8" placeholder="Descreva a fundamentação legal do parecer, incluindo base normativa e análise jurídica...">{{ old('fundamentacao', $parecerJuridico->fundamentacao) }}</textarea>
                                ...
                                <div class="mb-10">
                                    ...
                                    <textarea name="conclusao" class="form-control form-control-solid @error('conclusao') is-invalid @enderror" 
                                              rows="4" placeholder="Conclusão do parecer jurídico...">{{ old('conclusao', $parecerJuridico->conclusao) }}</textarea>
                                ...
                                <!--begin::Emendas-->
                                <div class="mb-10" id="emendas-container" style="{{ old('tipo_parecer', $parecerJuridico->tipo_parecer) == 'COM_EMENDAS' ? 'display: block;' : 'display: none;' }}">
                                    ...
                                    <textarea name="emendas" class="form-control form-control-solid @error('emendas') is-invalid @enderror" 
                                              rows="6" placeholder="Descreva as emendas sugeridas para a proposição...">{{ old('emendas', $parecerJuridico->emendas) }}</textarea>
                            ...
                            <div class="card-footer">
                                <div class="d-flex justify-content-end">
                                    <a href="{{ route('parecer-juridico.show', $parecerJuridico) }}" class="btn btn-light me-3">Cancelar</a>
                                    <button type="submit" class="btn btn-primary">Atualizar Parecer</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function toggleEmendas() {
        ...
        if (selectedValue === 'COM_EMENDAS') {
            ...
            if (selectedValue) { // Only clear if we're changing to a different option
