                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <select class="form-select mb-2" data-control="select2" data-placeholder="Selecione um cargo" data-allow-clear="true" name="cargo_mesa">
                                    ...
                                    @foreach($cargos as $cargo)
                                        <option value="{{ $cargo }}" {{ old('cargo_mesa') == $cargo ? 'selected' : '' }}>
                                            {{ $cargo }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="row mb-10">
                                <div class="col-md-6 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control mb-2" placeholder="Selecione a data" name="mandato_inicio" id="kt_datepicker_1" value="{{ old('mandato_inicio') }}" />
                                    <!--end::Input-->
                                ...
                                <div class="col-md-6 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control mb-2" placeholder="Selecione a data" name="mandato_fim" id="kt_datepicker_2" value="{{ old('mandato_fim') }}" />
                                    <!--end::Input-->
                                    @error('mandato_fim')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Textarea-->
                                <textarea class="form-control mb-2" rows="3" name="observacoes" placeholder="Observações sobre o mandato (opcional)">{{ old('observacoes') }}</textarea>
                                <!--end::Textarea-->
                                @error('observacoes')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
