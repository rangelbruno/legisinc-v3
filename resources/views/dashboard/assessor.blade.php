...
@section('title', 'Dashboard Assessor')
            ...
            <div class="row g-5 g-xl-8">
                    ...
                    <div class="card card-flush h-100 mb-5 mb-xl-10 dashboard-card-primary cursor-pointer">
                        ...
                        <div class="card-body d-flex flex-column justify-content-end pt-0">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <span class="badge badge-light-primary fs-8">{{ $estatisticas['total_assessoradas'] > 0 ? round(($estatisticas['em_elaboracao'] / $estatisticas['total_assessoradas']) * 100) : 0 }}%</span>
                            </div>
                            
                            <div class="progress h-6px bg-white bg-opacity-50">
                                <div class="progress-bar bg-white" style="width: {{ $estatisticas['total_assessoradas'] > 0 ? round(($estatisticas['em_elaboracao'] / $estatisticas['total_assessoradas']) * 100) : 0 }}%"></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-flush h-100 mb-5 mb-xl-10 dashboard-card-warning cursor-pointer">
                        ...
                        <div class="card-body d-flex flex-column justify-content-end pt-0">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <span class="badge badge-light-warning fs-8">{{ $estatisticas['total_assessoradas'] > 0 ? round(($estatisticas['aguardando_revisao'] / $estatisticas['total_assessoradas']) * 100) : 0 }}%</span>
                            </div>
                            
                            <div class="progress h-6px bg-white bg-opacity-50">
                                <div class="progress-bar bg-white" style="width: {{ $estatisticas['total_assessoradas'] > 0 ? round(($estatisticas['aguardando_revisao'] / $estatisticas['total_assessoradas']) * 100) : 0 }}%"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3">
                    <div class="card card-flush h-100 mb-5 mb-xl-10 dashboard-card-success cursor-pointer">
                        ...
                        <div class="card-body d-flex flex-column justify-content-end pt-0">
                            <div class="d-flex align-items-center mb-3">
                                <span class="fs-2hx fw-bold text-white me-2">{{ $estatisticas['enviadas_parlamentar'] }}</span>
                                <span class="fs-6 fw-semibold text-white opacity-75">enviadas</span>
                            </div>
                            
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <span class="fs-6 fw-bold text-white">Enviadas ao Parlamentar</span>
                                <span class="badge badge-light-success fs-8">{{ $estatisticas['total_assessoradas'] > 0 ? round(($estatisticas['enviadas_parlamentar'] / $estatisticas['total_assessoradas']) * 100) : 0 }}%</span>
                            </div>
                            
                            <div class="progress h-6px bg-white bg-opacity-50">
                                <div class="progress-bar bg-white" style="width: {{ $estatisticas['total_assessoradas'] > 0 ? round(($estatisticas['enviadas_parlamentar'] / $estatisticas['total_assessoradas']) * 100) : 0 }}%"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3">
                    <div class="card card-flush h-100 mb-5 mb-xl-10 dashboard-card-info cursor-pointer">
                        ...
                        <div class="card-body d-flex flex-column justify-content-end pt-0">
                            <div class="d-flex align-items-center mb-3">
                                <span class="fs-2hx fw-bold text-white me-2">{{ $estatisticas['total_assessoradas'] }}</span>
                                <span class="fs-6 fw-semibold text-white opacity-75">assessoradas</span>
                            </div>
                            
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <span class="fs-6 fw-bold text-white">Total Assessoradas</span>
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">Dashboard Assessor</span>
                                <span class="text-muted fw-semibold fs-7">Suporte ao trabalho parlamentar</span>
                            </h3>
                        </div>
                        <!--end::Header-->
                        <!--begin::Body-->
                            ...
                            <div class="text-center py-10">
                                <div class="symbol symbol-100px mb-5">
                                    <span class="symbol-label bg-light-success">
                                        <i class="ki-duotone ki-user-square text-success fs-1">
                                            <span class="path1"></span>
                                            <span class="path2"></span>
                                            <span class="path3"></span>
                                        </i>
                                ...
                                <h3 class="text-gray-800 fs-2 fw-bold mb-3">Dashboard do Assessor</h3>
                                
                                <p class="text-gray-600 fs-6 fw-semibold mb-8">
                                    O dashboard específico para assessores está sendo desenvolvido.<br/>
                                    Em breve você poderá gerenciar as proposições que assessora diretamente desta tela.
                                </p>
                                
                                @if($parlamentarVinculado)
                                    <div class="alert alert-info d-flex align-items-center p-5 mb-10">
                                        <div class="d-flex flex-column text-start">
                                            <h5 class="mb-1">Parlamentar Vinculado</h5>
                                            <span>Você está assessorando: <strong>{{ $parlamentarVinculado->name }}</strong></span>
                                        </div>
                                    </div>
                                @endif
