    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card">
                ...
                <!--begin::Form-->
                <form id="kt_user_form" action="{{ route('admin.usuarios.update', $usuario) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <!--begin::Card body-->
                    <div class="card-body pt-0">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="name" class="form-control form-control-lg form-control-solid @error('name') is-invalid @enderror" 
                                       placeholder="Nome completo do usuário" value="{{ old('name', $usuario->name) }}" required />
                                @error('name')
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                <input type="email" name="email" class="form-control form-control-lg form-control-solid @error('email') is-invalid @enderror" 
                                       placeholder="email@exemplo.com" value="{{ old('email', $usuario->email) }}" required />
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-6">
                            <label class="col-lg-4 col-form-label fw-semibold fs-6">Nova Senha</label>
                            <div class="col-lg-8">
                        ...
                        <div class="row mb-6">
                            <label class="col-lg-4 col-form-label fw-semibold fs-6">Confirmar Nova Senha</label>
                            <div class="col-lg-8">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="documento" class="form-control form-control-lg form-control-solid @error('documento') is-invalid @enderror" 
                                       placeholder="CPF, RG ou outro documento" value="{{ old('documento', $usuario->documento) }}" />
                                @error('documento')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="telefone" class="form-control form-control-lg form-control-solid @error('telefone') is-invalid @enderror" 
                                       placeholder="(00) 00000-0000" value="{{ old('telefone', $usuario->telefone) }}" />
                                @error('telefone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="profissao" class="form-control form-control-lg form-control-solid @error('profissao') is-invalid @enderror" 
                                       placeholder="Profissão do usuário" value="{{ old('profissao', $usuario->profissao) }}" />
                                @error('profissao')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="cargo_atual" class="form-control form-control-lg form-control-solid @error('cargo_atual') is-invalid @enderror" 
                                       placeholder="Cargo atual do usuário" value="{{ old('cargo_atual', $usuario->cargo_atual) }}" />
                                @error('cargo_atual')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="partido" class="form-control form-control-lg form-control-solid @error('partido') is-invalid @enderror" 
                                       placeholder="Partido político (se aplicável)" value="{{ old('partido', $usuario->partido) }}" />
                                @error('partido')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-lg-8">
                                <select name="role" class="form-select form-select-lg form-select-solid @error('role') is-invalid @enderror" required>
                                    ...
                                    @foreach($perfis as $key => $nome)
                                        <option value="{{ $key }}" 
                                                {{ (old('role') ?: $usuario->getRoleNames()->first()) === $key ? 'selected' : '' }}>
                                            {{ $nome }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-lg-8">
                                <div class="form-check form-switch form-check-custom form-check-solid">
                                    ...
                                    @if(auth()->id() === $usuario->id)
                                        ...
                                        <div class="form-text">Você não pode desativar sua própria conta</div>
                                    @endif
                                </div>
                            </div>
                        </div>
