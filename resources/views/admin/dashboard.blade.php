    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="row gy-5 gx-xl-8 mt-5 mt-xl-8">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="card card-xl-stretch mb-xl-8 card-hover cursor-pointer" onclick="window.location.href='{{ route('admin.workflows.index') }}'">
                        <div class="card-body d-flex align-items-center pt-3 pb-0">
                            <div class="d-flex flex-column flex-grow-1 py-2 py-lg-13 me-2">
                                <a href="{{ route('admin.workflows.index') }}" class="fw-bold text-gray-900 fs-4 mb-2 text-hover-primary d-flex align-items-center">
                                    🔄 Sistema de Workflows
                                    <span class="badge badge-light-primary ms-2">ADMIN</span>
                                    <i class="ki-duotone ki-arrow-right fs-5 ms-2">
                                        <span class="path1"></span>
                                        <span class="path2"></span>
                                    </i>
                                </a>
                                <span class="fw-semibold text-muted fs-5">Fluxos modulares de tramitação</span>
                            </div>
                            <i class="ki-duotone ki-route text-success fs-4x align-self-end h-100px">
                                <span class="path1"></span>
                                <span class="path2"></span>
                                <span class="path3"></span>
                            </i>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="card card-xl-stretch mb-xl-8 card-hover cursor-pointer" onclick="window.location.href='{{ route('admin.guia-desenvolvimento.index') }}'">
                        <div class="card-body d-flex align-items-center pt-3 pb-0">
                            <div class="d-flex flex-column flex-grow-1 py-2 py-lg-13 me-2">
                                <a href="{{ route('admin.guia-desenvolvimento.index') }}" class="fw-bold text-gray-900 fs-4 mb-2 text-hover-primary d-flex align-items-center">
                                    🚀 Guia de Desenvolvimento
                                    <span class="badge badge-light-warning ms-2">NOVO</span>
                                    <i class="ki-duotone ki-arrow-right fs-5 ms-2">
                                        <span class="path1"></span>
                                        <span class="path2"></span>
                                    </i>
                                </a>
                                <span class="fw-semibold text-muted fs-5">Crie módulos com boas práticas</span>
                            </div>
                            <i class="ki-duotone ki-code text-warning fs-4x align-self-end h-100px">
                                <span class="path1"></span>
                                <span class="path2"></span>
                                <span class="path3"></span>
                                <span class="path4"></span>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="card card-xl-stretch mb-xl-8 card-hover cursor-pointer" onclick="window.location.href='{{ route('admin.document-workflow-logs.index') }}'">
                        <div class="card-body d-flex align-items-center pt-3 pb-0">
                            <div class="d-flex flex-column flex-grow-1 py-2 py-lg-13 me-2">
                                <a href="{{ route('admin.document-workflow-logs.index') }}" class="fw-bold text-gray-900 fs-4 mb-2 text-hover-primary d-flex align-items-center">
                                    📊 Logs do Fluxo
                                    <span class="badge badge-light-success ms-2">NOVO</span>
                                    <i class="ki-duotone ki-arrow-right fs-5 ms-2">
                                        <span class="path1"></span>
                                ...
                                <span class="fw-semibold text-muted fs-5">Monitoramento e análise de logs</span>
                            </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="card card-xl-stretch mb-xl-8 card-hover cursor-pointer" onclick="window.location.href='{{ route('admin.system-diagram.index') }}'">
                        <div class="card-body d-flex align-items-center pt-3 pb-0">
                            <div class="d-flex flex-column flex-grow-1 py-2 py-lg-13 me-2">
                                <a href="{{ route('admin.system-diagram.index') }}" class="fw-bold text-gray-900 fs-4 mb-2 text-hover-primary d-flex align-items-center">
                                    📊 Arquitetura do Sistema
                                    <span class="badge badge-light-info ms-2">NOVO</span>
                                    <i class="ki-duotone ki-arrow-right fs-5 ms-2">
                                        <span class="path1"></span>
                                ...
                                <span class="fw-semibold text-muted fs-5">Diagramas e fluxos do sistema</span>
                            </div>
                            <i class="ki-duotone ki-graph-3 text-info fs-4x align-self-end h-100px">
                                <span class="path1"></span>
                                <span class="path2"></span>
                            </i>
                        </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="card card-xl-stretch mb-xl-8 card-hover cursor-pointer" onclick="window.location.href='{{ route('admin.technical-doc.index') }}'">
                        <div class="card-body d-flex align-items-center pt-3 pb-0">
                            <div class="d-flex flex-column flex-grow-1 py-2 py-lg-13 me-2">
                                <a href="{{ route('admin.technical-doc.index') }}" class="fw-bold text-gray-900 fs-4 mb-2 text-hover-primary d-flex align-items-center">
                                    📚 Documentação Técnica
                                    <span class="badge badge-light-primary ms-2">NOVO</span>
                                    <i class="ki-duotone ki-arrow-right fs-5 ms-2">
                                        <span class="path1"></span>
                                ...
                                <span class="fw-semibold text-muted fs-5">Fluxos, arquivos e endpoints</span>
                            </div>
                            <i class="ki-duotone ki-code text-primary fs-4x align-self-end h-100px">
                                <span class="path1"></span>
                                <span class="path2"></span>
                ...
                <!-- Arquitetura Gateway -->
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="card card-xl-stretch mb-xl-8 card-hover cursor-pointer" onclick="window.location.href='{{ route('admin.arquitetura.index') }}'">
                        <div class="card-body d-flex align-items-center pt-3 pb-0">
                            <div class="d-flex flex-column flex-grow-1 py-2 py-lg-13 me-2">
                                <a href="{{ route('admin.arquitetura.index') }}" class="fw-bold text-gray-900 fs-4 mb-2 text-hover-primary d-flex align-items-center">
                                ...
                                <span class="fw-semibold text-muted fs-5">Canary, Shadow Traffic & Observabilidade</span>
                            </div>
                            <i class="ki-duotone ki-abstract-26 text-warning fs-4x align-self-end h-100px">
                                <span class="path1"></span>
                                <span class="path2"></span>
                            </i>
                        </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="card card-xl-stretch mb-xl-8 card-hover cursor-pointer" onclick="window.location.href='{{ route('admin.migration-preparation.index') }}'">
                        <div class="card-body d-flex align-items-center pt-3 pb-0">
                            <div class="d-flex flex-column flex-grow-1 py-2 py-lg-13 me-2">
                                <a href="{{ route('admin.migration-preparation.index') }}" class="fw-bold text-gray-900 fs-4 mb-2 text-hover-primary d-flex align-items-center">
                                    🔄 Preparação para Migração
                                    <span class="badge badge-light-primary ms-2">NOVO</span>
                                    <i class="ki-duotone ki-arrow-right fs-5 ms-2">
                                        <span class="path1"></span>
                                ...
                                <span class="fw-semibold text-muted fs-5">Gerar JSON para migrar backend</span>
                            </div>
                            <i class="ki-duotone ki-switch text-primary fs-4x align-self-end h-100px">
                                <span class="path1"></span>
                                <span class="path2"></span>
                            </i>
                        </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="card card-xl-stretch mb-xl-8 card-hover cursor-pointer" onclick="window.location.href='{{ route('admin.monitoramento.index') }}'">
                        <div class="card-body d-flex align-items-center pt-3 pb-0">
                            <div class="d-flex flex-column flex-grow-1 py-2 py-lg-13 me-2">
                                <a href="{{ route('admin.monitoramento.index') }}" class="fw-bold text-gray-900 fs-4 mb-2 text-hover-primary d-flex align-items-center">
                                    📊 Monitoramento
                                    <span class="badge badge-light-success ms-2">NOVO</span>
                                    <i class="ki-duotone ki-arrow-right fs-5 ms-2">
                                        <span class="path1"></span>
                                ...
                                <span class="fw-semibold text-muted fs-5">Grafana, Prometheus & Métricas</span>
                            </div>
                            <i class="ki-duotone ki-chart-line-up text-success fs-4x align-self-end h-100px">
                                <span class="path1"></span>
                                <span class="path2"></span>
