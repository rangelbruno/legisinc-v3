...
class TemplateController extends Controller
{
    ...
    /**
     * Lista todos os tipos com seus templates e dados do template universal
     */
    public function index()
    {
        ...
        // Dados do template universal
        $templateUniversal = TemplateUniversal::getDefault();
        $estatisticasUniversal = $this->templateUniversalService->getEstatisticas();

        return view('admin.templates.index', compact('tipos', 'templateUniversal', 'estatisticasUniversal'));
    }
